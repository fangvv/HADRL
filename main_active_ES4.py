...
from environment_ES4 import MultiAgentEnv
...
def train(arglist):
    ...
    for episode_gone in range(arglist.max_episode):
        ...
        if episode_gone % 10 == 0:
            ...
            with open("simulation_edge/reward_large_user30_edge4_active2.txt", "w") as f:
                for r in rewards_server_cache:
                    f.write(str(r) + '\n')

            with open("simulation_edge/reward_small_user30_edge4_active2.txt", "w") as f:
                for r_small in rewards_samll:
                    f.write(str(r_small) + '\n')

            with open("simulation_edge/users_time_user30_edge4_active2.txt", "w") as f:
                for time in users_time:
                    f.write(str(time) + '\n')

            with open("simulation_edge/users_energy_user30_edge4_active2.txt", "w") as f:
                for energy in users_energy:
                    f.write(str(energy) + '\n')

            with open("simulation_edge/users_server_user30_edge4_active2.txt", "w") as f:
                for server in server_switch_cost:
                    f.write(str(server) + '\n')


            with open("simulation_edge/users_hit_user30_edge4_active2.txt", "w") as f:
