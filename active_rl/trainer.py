...
class Trainer(object):
    def __init__(
        ...
        self.params = list(ensemble.parameters())
        self.params1 = list(reward_model.parameters())
        self.optim = torch.optim.Adam(self.params, lr=learning_rate, eps=epsilon)
        self.optim1 = torch.optim.Adam(self.params, lr=learning_rate, eps=epsilon)

    def train(self, n_train_epochs):
        e_losses = []
        r_losses = []
        n_batches = []
